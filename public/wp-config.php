...
// Set the site url explicitly so that it can't be messed up via the UI.
define('WP_HOME','https://wp-eval.herokuapp.com/');
define('WP_SITEURL','https://wp-eval.herokuapp.com/');
